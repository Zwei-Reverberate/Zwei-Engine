...
void ZwRenderPass::init(ZwLogicalDevice* pLogicalDevice, ZwPhysicalDevice* pPhysicalDevice, ZwSwapChain* pSwapChain)
{
	if (!pLogicalDevice || !pSwapChain || !pPhysicalDevice)
		return;
